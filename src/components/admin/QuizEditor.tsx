        ...
        <div style={{ marginTop: "2rem", borderTop: "1px solid var(--border)", paddingTop: "2rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
                {questions.map((q, qIndex) => (
                    <div key={qIndex} className="card" style={{ padding: "1.5rem", border: "1px solid var(--border)" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
                            ...
                            <button
                                ...
                                className="btn-icon"
                                style={{ color: "var(--error)", marginLeft: "1rem", alignSelf: "center" }}
                            >
                                <Trash2 size={18} />
                            </button>
                        </div>
                        ...
                        <div style={{ paddingLeft: "1rem" }}>
                            <label className="label" style={{ fontSize: "0.9rem" }}>Options</label>
                            <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                                ...
                                >
                                    <Plus size={14} style={{ marginRight: "0.25rem" }} /> Add Option
                                </button>
                            </div>
                        </div>
                    </div>
