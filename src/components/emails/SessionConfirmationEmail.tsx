...
export const SessionConfirmationEmail = ({
  ...
  return (
    <Html>
      ...
      <Preview>Your session has been successfully created!</Preview>
      ...
      <Body style={main}>
        ...
        <Container style={card}>
          ...
          <Section style={content}>
            <Text style={text}>
              Hi {tutorName}, your 1-on-1 session "{sessionTitle}" has been
            ...
            <Text style={mutedText}>
              The student will receive an invite to this meeting. Please make
              sure to be available at the scheduled time.
            </Text>
          </Section>
        </Container>
        <Section style={spacer} />
