...
import { T, DIFF_COLOR } from "../../components/constants";
    ...
    <>
      ...
      >
        ...
        /> */}
          ...
          >
            14 interactive courses covering everything from fundamentals to
            Python models — built for analysts and engineers who are brand new
            to dbt.
          </p>
          <div
            style={{
        ...
        >
          {filtered.map((c, i) => (
            <div
              ...
              style={{
                background:
                  hovered === c.id ? "rgba(15,23,42,0.98)" : T.surface,
                ...
                boxShadow:
                  hovered === c.id ? `0 10px 32px ${c.color}14` : "none",
