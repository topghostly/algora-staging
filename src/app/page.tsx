...
import { ArrowRight, CheckCircle, Code, Users, Award } from "lucide-react";
      ...
      <section style={{
        ...
        <div className="container">
          ...
          <h1 style={{
            ...
            Master Tech Skills with <span style={{ color: "var(--primary)" }}>Structured Mentorship</span>
          </h1>
          <p style={{
            fontSize: "1.25rem",
            color: "var(--muted)",
            ...
            Stop wasting time on scattered tutorials. Get a structured curriculum, expert mentorship, and a portfolio that gets you hired.
          </p>
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center" }}>
            <Link href="/auth/signup" className="btn btn-primary" style={{ padding: "0.75rem 2rem", fontSize: "1.1rem" }}>
              Start Learning Free
            </Link>
            <Link href="/tracks" className="btn btn-outline" style={{ padding: "0.75rem 2rem", fontSize: "1.1rem" }}>
              View Curriculum
            </Link>
          </div>
        </div>
      ...
      <section style={{ padding: "5rem 0" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            <h2 style={{ fontSize: "2.5rem", fontWeight: 700, marginBottom: "1rem" }}>Why Choose Algora?</h2>
            <p style={{ color: "var(--muted)", fontSize: "1.1rem" }}>We bridge the gap between self-learning and expensive bootcamps.</p>
          </div>
      ...
      <section style={{ padding: "5rem 0 10rem 0", backgroundColor: "var(--secondary)", color: "white" }}>
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <Link href="/auth/signup" className="btn" style={{
            ...
            Get Started Now <ArrowRight size={20} style={{ marginLeft: "0.5rem", verticalAlign: "middle" }} />
          </Link>
        </div>
      </section>
    </main>
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode, title: string, description: string }) {
  return (
    <div className="card" style={{ padding: "2rem", textAlign: "left", transition: "transform 0.2s" }}>
      <div style={{
        width: "60px",
        height: "60px",
        borderRadius: "12px",
